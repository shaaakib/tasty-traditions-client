        ...
        <div className="relative">
          ...
          >
            ...
            <div className="space-x-6">
              ...
              <button
                ...
                className="text-black dark:text-black focus:outline-none focus:ring-2 focus:ring-gray-800"
              >
                {/* <svg
                  className="fill-stroke"
                  width={18}
          ...
          <div className="dark:bg-gray-900  px-6 py-9">
            <div className="container mx-auto flex items-center justify-between">
              <h1
                className="md:w-2/12 cursor-pointer text-black dark:text-black"
                aria-label="the Crib."
              >
                {/* <svg
                  className="fill-stroke"
                ...
                <img className="w-24  fill-white" src="" alt="" />
              </h1>
              <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                <li>
                  <a
                    href="javascript:void(0)"
                    className="dark:text-black text-base text-black focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"
                  >
                    News
                  </a>
                </li>
              ...
              <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                <div className="hidden lg:flex items-center">
                  <button
                    ...
                    className="text-black dark:hover:text-gray-300 dark:text-black focus:outline-none focus:ring-2 focus:ring-gray-800"
                  >
                    <svg
                      className="fill-stroke"
                      width={24}
            ...
            <div className="mt-6 p-4">
              <ul className="flex flex-col space-y-6">
                <li>
                  <a
                    href="javascript:void(0)"
                    className="dark:text-black flex items-center justify-between hover:underline text-base text-black focus:outline-none focus:ring-2 focus:ring-gray-800"
                  >
                    News
                    <div>
                      <svg
