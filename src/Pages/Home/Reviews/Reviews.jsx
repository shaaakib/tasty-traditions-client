...
export default function Reviews() {
  return (
    <div className="grid lg:grid-cols-2 mt-20 px-32">
      ...
      <div class="max-w-2xl mx-auto mt-8 flex gap-x-7 items-center">
        ...
        <div className="">
          ...
          <div>
            <p class="mt-2">
              <span className="underline">Ranveer Brar</span> This was so smoky
              and delicious! The eggplant was perfectly cooked and the spices
              were spot-on.
            </p>
          </div>
        </div>
